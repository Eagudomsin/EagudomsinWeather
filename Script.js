let weather = {
    ...
    fetchWeather: function (city) {
        fetch(
            `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${this.apiKey}&fbclid=IwAR0flGDKUCeNP4ezglCgvCmzraFwnTTjG59fiz91nrrCZS_nNuIYS9yQ6e8`
        ).then((response) => {
            if (!response.ok) {
